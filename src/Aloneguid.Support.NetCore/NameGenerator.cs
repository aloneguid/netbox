...
#region [ Docker Data ]
      ...
      /// </summary>
      public static string GeneratePersonFirstName()
      {
         if (_firstNames == null) _firstNames = DataLoader.LoadFirstNames();

         return _firstNames[Generator.GetRandomInt(_firstNames.Length)];
      }

      /// <summary>
      /// Generates a random person last name from an embedded database of over 8'000 last names
      /// </summary>
      public static string GeneratePersonLastName()
      {
         if (_lastNames == null) _lastNames = DataLoader.LoadLastNames();

         return _lastNames[Generator.GetRandomInt(_lastNames.Length)];
      }

      /// <summary>
      /// Generates a random person name in the format of FirstName LastName
      /// </summary>
      public static string GeneratePersonFullName()
      {
